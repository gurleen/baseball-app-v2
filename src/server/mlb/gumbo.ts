...
export const MlbGameFeedDiffPatchResponse = z.union([
	MlbGameFeedDiffPatch,
	MlbGameFeedDiffPatchFallback
]);
...
export function getMlbGameFeedDiffPatch(gameId: number | string, query: MlbGameFeedDiffPatchQuery) {
	const { signal, language = DEFAULT_GUMBO_LANGUAGE, startTimecode, pushUpdateId } = query;
