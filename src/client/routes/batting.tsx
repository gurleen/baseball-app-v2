...
const columns = [
	...
	columnHelper.accessor('avg', {
		...
		sortingFn: (a, b) => sortNullable(a.original.avg, b.original.avg)
	}),
	columnHelper.accessor('obp', {
		header: 'OBP',
		cell: (info) => fmtRate(info.getValue()),
		sortingFn: (a, b) => sortNullable(a.original.obp, b.original.obp)
	}),
	columnHelper.accessor('slg', {
		header: 'SLG',
		cell: (info) => fmtRate(info.getValue()),
		sortingFn: (a, b) => sortNullable(a.original.slg, b.original.slg)
	}),
	columnHelper.accessor('ops', {
		header: 'OPS',
		cell: (info) => fmtRate(info.getValue()),
		sortingFn: (a, b) => sortNullable(a.original.ops, b.original.ops)
	}),
	columnHelper.accessor('bbPct', {
		header: 'BB%',
		cell: (info) => fmtPct(info.getValue()),
		sortingFn: (a, b) => sortNullable(a.original.bbPct, b.original.bbPct)
	}),
	columnHelper.accessor('kPct', {
		header: 'K%',
		cell: (info) => fmtPct(info.getValue()),
		sortingFn: (a, b) => sortNullable(a.original.kPct, b.original.kPct)
	}),
	columnHelper.accessor('bbK', {
		header: 'BB/K',
		cell: (info) => info.getValue()?.toFixed(2) ?? '—',
		sortingFn: (a, b) => sortNullable(a.original.bbK, b.original.bbK)
	}),
	columnHelper.accessor('iso', {
		header: 'ISO',
		cell: (info) => fmtRate(info.getValue()),
		sortingFn: (a, b) => sortNullable(a.original.iso, b.original.iso)
	}),
	...
	columnHelper.accessor('woba', {
		header: 'wOBA',
		cell: (info) => fmtRate(info.getValue()),
		sortingFn: (a, b) => sortNullable(a.original.woba, b.original.woba)
	}),
	columnHelper.accessor('wrcPlus', {
		header: 'wRC+',
		cell: (info) => info.getValue() ?? '—',
		sortingFn: (a, b) => sortNullable(a.original.wrcPlus, b.original.wrcPlus)
	})
];
