...
import { StatcastTab } from '../components/StatcastTab.tsx';
import { SettingsTab } from '../components/SettingsTab.tsx';
import type { GameSnapshot } from '../../shared/models.ts';

const TABS = ['PREVIEW', 'AT BAT', 'OFFENSE', 'PITCHING', 'SUMMARY', 'STATCAST', 'ABS', 'SETTINGS'] as const;
			...
			return (
				<div style={{ padding: 'var(--sp-4)' }}>
					<Panel title="GAME">
						...
						<div
							style={{ color: 'var(--fg-3)', fontSize: 'var(--fs-10)', marginTop: 'var(--sp-2)' }}
						>
							{game.error.message}
						</div>
					</Panel>
		...
		<div style={{ ...fullWidthColumn, padding: 'var(--sp-4)', gap: 'var(--sp-3)' }}>
			...
			<div>
				...
				<div style={{ marginTop: 'var(--sp-3)' }}>
					...
					{active === 'STATCAST' && <StatcastTab snapshot={snapshot} />}
